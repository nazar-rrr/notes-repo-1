...
const manipulateMainNav = () => {
    ...
    const theTasksNavUnexist = theTasksNav && theTasksNav.classList.contains('hidden');
    
    theMainNav.classList.contains('hidden') && theTasksNavUnexist ? renderMainNav() : removeMainNav();
};
